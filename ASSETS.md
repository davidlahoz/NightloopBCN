...
- **Streetlight** (`godot/assets/props/streetlight.glb`) — user-provided model (source/license TBD — please fill in). Merged and normalised at runtime for the Barcelona streetlight field.
