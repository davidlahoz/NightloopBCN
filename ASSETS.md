...
- **Caltrans streetlight 2** (`godot/assets/props/streetlight.glb`) — [skfb.ly/oC6ON](https://skfb.ly/oC6ON) by [Streetlights & ETC](https://sketchfab.com/streetlights), licensed under [Creative Commons Attribution 4.0](http://creativecommons.org/licenses/by/4.0/). Merged and normalised at runtime for the Barcelona streetlight field.
- **M.A.V.S — MAdvanced Vehicle System** (`godot/addons/M.A.V.S/`) — by [Millu30](https://github.com/Dente222/MAdvanced-Vehicle-Controller), MIT license. Its VehicleBody3D controller powers promoted ambient-traffic cars.
